...
//	
	...
	public static void tableValidation(WebDriver driver) throws Exception{
		...
		for(int i=1;i<rows.size();i++){
			...
			String act_data=driver.findElement(By.xpath("//table[@id='tbl_a_supplierslist']/tbody/tr["+i+"]/td[6]/div/span/span")).getText();
